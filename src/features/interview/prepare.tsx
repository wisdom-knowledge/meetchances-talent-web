            ...
            <div className='flex flex-col lg:flex-row items-center justify-center gap-[120px]'>
              ...
              <div className='flex flex-col items-start gap-8'>
                ...
                <div className='flex flex-col gap-5'>
                  <h2 className='text-2xl font-semibold tracking-[0.48px] text-foreground'>审核中…</h2>
                  <div className='flex flex-col gap-4'>
                    ...
                    <div className='flex items-center gap-5'>
                      <div className='flex flex-col items-center gap-1'>
                        <div className='w-8 h-8 rounded-lg bg-[#C994F7] flex items-center justify-center'>
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path d="M12 2C6.486 2 2 5.589 2 10C2 12.908 3.898 15.516 7 16.934V22L12.34 17.995C17.697 17.852 22 14.32 22 10C22 5.589 17.514 2 12 2ZM12 16H11.667L9 18V15.583L8.359 15.336C5.67 14.301 4 12.256 4 10C4 6.691 7.589 4 12 4C16.411 4 20 6.691 20 10C20 13.309 16.411 16 12 16Z" fill="white"/>
                          </svg>
                        </div>
                        <span className='text-sm leading-[1.6] text-foreground/70'>短信</span>
                      </div>
                      <div className='flex flex-col items-center gap-1'>
                        <div className='w-8 h-8 rounded-lg bg-[#C994F7] flex items-center justify-center'>
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <img className='w-[269px] h-[83px]' src="https://dnu-cdn.xpertiise.com/common/50c66d42-cd45-4e67-a9ca-e9c5ea6cc3bc.png" alt="" />
                  </div>
                </div>
                {/* 按钮 */}
                {interviewNodeStatus === JobApplyNodeStatus.CompletedPendingReview && (
                  <div className='flex gap-3'>
                    <Button 
                      ...
                      className='h-11 px-7 py-4 rounded-lg bg-gradient-to-r from-[#4E02E4] to-[#C994F7] hover:opacity-90 text-white text-base font-medium tracking-[0.4px]'
                    >
                      退出
                    </Button>
                    <Button 
                      ...
                      className='h-11 px-7 py-4 rounded-lg border-[0.5px] border-primary bg-white hover:bg-accent text-foreground text-base font-medium tracking-[0.4px]'
                    >
                      重新面试
                    </Button>
                </div>
